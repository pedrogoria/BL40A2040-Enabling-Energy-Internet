...
n_sim_channel = 20  # number of simulated channels
data_path = 'data/complex_0_20C_512train_32test/'
n_slices = 32  #
epochs = 30
model_path = 'model_residual 20C 4096trains 30epochs 64batch/'
...
frame_to_train = [512, None, 64, 1]  # [frames number, None, temporal samples, 1]
frame_to_test = [32, None, 64, 1]  # [frames number, None, temporal samples, 1]
#
